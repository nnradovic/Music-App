...
import { Card, Button, List, Icon, ListItem} from 'react-native-elements'
import * as actions from '../actions'
import _ from 'lodash'

export default class FvoriteScreen extends React.Component {
  ...
  async deleteAlbum(albumId){
     ...
     const sucess = await actions.storeData('favoriteAlbums', favoriteAlbums);
